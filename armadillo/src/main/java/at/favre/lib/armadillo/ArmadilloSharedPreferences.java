...
public interface ArmadilloSharedPreferences extends SharedPreferences {
    ...
    /**
     * Changes the user provided password to the new given password and sets a new strechting function.
     ...
     * @param function    set a new function to be used the encrypt with new password
     */
    void changePassword(char[] newPassword, KeyStretchingFunction function);
